...
function initCekKuota() {
  ...
  cekBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      info.innerHTML = `
        <p><i class="fa-solid fa-phone mr-2 text-cyan-400"></i><b>Nomer XL/Axis:</b> ${subs.msisdn}</p>
        <p><i class="fa-solid fa-signal mr-2 text-cyan-400"></i><b>Operator:</b> ${subs.operator}</p>
        <p><i class="fa-solid fa-wifi mr-2 text-cyan-400"></i><b>Jenis Jaringan:</b> ${subs.net_type}</p>
